...
<div class="card shadow">
    ...
    <div class="card-body">
        <a class="btn btn-outline-primary btn-sm" title="Tambah User" data-toggle="modal" data-target="#modalContainer"
            data-title="Tambah User" href="{{ route('user.create') }}"><i class="fa fa-plus fa-fw"></i>
            Tambah
            User</a>
        <div class="table-responsive mt-3">
            <table id="userTable" class="table table-sm table-bordered table-hover" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        <th></th>
                        <th>No.</th>
...
<script type="text/javascript">
    tableDokumen = $('#userTable').DataTable({
        responsive: true,
        processing: true,
        serverSide: true,
